...
def renewal_map(img, observation):
    ...
    Pacman_left = (observation[10] - 3, observation[16]+2)
    Pacman_right = (observation[10] - 12, observation[16]+11)
...
def pacman_obs_Ram(observation):
    parameter = {
        ...
        'advantages': [
            (observation[10] - 8, observation[16]+4),
        ]
    }
    return parameter
